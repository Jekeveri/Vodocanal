...
def derive_key(salt, password):
    kdf = Scrypt(salt=salt, length=32, n=2**14, r=9, p=1)
...
if __name__ == "__main__":
    ...
    parser.add_argument("-s", "--salt-size", help="Если значение задано, генерируется новая соль", type=int)
    ...
    if args.encrypt:
        ...
        password = getpass.getpass("Введите пароль, который вы использовали при шифровании: ")
    ...
    if encrypt_ and decrypt_:
        ...
        raise TypeError("Пожалуйста, укажите, хотите ли вы зашифровать данные или расшифровать их. ")
