import flet as ft
import src.database.bd_admin.select_server  # Импортируем функцию для получения данных о сотрудниках
import src.database.bd_admin.update_server
import src.admin.admin_main
...
def employer_tab(page, id_tasks):
    ...
    def update_table():
        ...
        results = src.database.bd_admin.select_server.select_employer_data_statistic_tasks()
    ...
    def update_task(e):
        src.database.bd_admin.update_server.set_employer_to_task(id_tasks, emp_id)
        src.admin.admin_main.AdminPanel.return_tab()
