import flet as ft
import src.database.bd_admin.select_server  # Импортируем функцию для получения данных из БД
...
def assignment_tab(page):
    ...
    def update_table():
        ...
        results = src.database.bd_admin.select_server.select_task_data_unmade()
        ...
        ft.Row(
            [
                ...
                ft.ElevatedButton("Назначить",
                                  on_click=lambda e: ad.AdminPanel.add_new_tab(page, selected_rows)),
            ],
